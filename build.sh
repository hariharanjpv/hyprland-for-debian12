...
STEPS=(00-apt 01-toolchain 02-c-core 03-cpp-deps 04-hypr-libs 05-hyprland 06-hyprlock 07-waybar)
...
Build complete.
  ...
  2. Add the session entry:      sudo cp /opt/hypr/share/wayland-sessions/hyprland.desktop \
